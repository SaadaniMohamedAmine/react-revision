...
const Features = () => {
  return (
    <>
      ...
      <div class="flex flex-col md:flex-row md:py-16 px-5 md:px-16 text-center">
        <div class="mr-2 l md:p-3 cursor-pointer md:hover:scale-150 transition ease-in duration-800">
          <img
            ...
            alt=""
          />
          <p class="text-zinc-800">Option 1 Meet</p>
        </div>
        <div class="mr-2 mt-5 md:p-3 cursor-pointer md:hover:scale-150 transition ease-in duration-800">
          <img
            ...
            alt=""
          />
          <p class="text-zinc-800">Option 2 Meet</p>
        </div>
        <div class="mr-2 md:p-3 cursor-pointer md:hover:scale-150 transition ease-in duration-800">
          <img
            ...
            alt=""
          />
          <p class="text-zinc-800">Option 3 Meet</p>
        </div>
        <div class="mr-2 mt-5 md:p-3 cursor-pointer md:hover:scale-150 transition ease-in duration-800">
          <img
            ...
            alt=""
          />
          <p class="text-zinc-800">Option 4 Meet</p>
        </div>
      </div>
    </>
  );
